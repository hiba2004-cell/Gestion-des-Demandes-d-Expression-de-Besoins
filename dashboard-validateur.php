...
/**
 * Retourne la classe CSS correspondant au statut pour l'affichage du badge.
 * @param string $statut
 * @return string
 */
        ...
        <form method="GET" class="row g-3">
          ...
          <div class="col-md-3">
            ...
            <select name="statut" class="form-select">
              ...
              <option value="En attente" <?php echo ($selected_statut === 'En attente') ? 'selected' : ''; ?>>En attente</option>
              <option value="En cours de validation" <?php echo ($selected_statut === 'En cours de validation') ? 'selected' : ''; ?>>En cours de validation</option>
              <option value="Validée" <?php echo ($selected_statut === 'Validée') ? 'selected' : ''; ?>>Validée</option>
              <option value="Rejetée" <?php echo ($selected_statut === 'Rejetée') ? 'selected' : ''; ?>>Rejetée</option>
              <option value="Traitée" <?php echo ($selected_statut === 'Traitée') ? 'selected' : ''; ?>>Traitée</option>
            </select>
          </div>

          <div class="col-md-3">
            <label class="form-label fw-bold">Demandeur</label>
            <input type="text" name="demandeur" class="form-control" placeholder="Nom du demandeur" value="<?php echo htmlspecialchars($selected_demandeur); ?>">
          </div>
                            ...
                            <tbody>
                                <?php foreach ($demandes as $demande): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <strong class="d-block"><?php echo htmlspecialchars($demande['description']); ?></strong>
                                            <small class="text-muted">Type: <?php echo htmlspecialchars($demande['type_besoin']); ?></small>
                                        </td>
                                        <td>
                                            <span class="d-block fw-bold"><?php echo htmlspecialchars($demande['demandeur']); ?></span>
                                            <small class="text-muted"><?php echo htmlspecialchars($demande['demandeur_email']); ?></small>
                                        </td>
                                        <td>
                                            <?php 
