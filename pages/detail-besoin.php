                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="titre" 
                                       name="titre" 
                                       value="<?php echo htmlspecialchars($besoin['titre']); ?>"
                                       required 
                                       maxlength="200">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="priorite" name="priorite" required>
                                    <option value="faible" <?php echo ($besoin['priorite'] === 'faible') ? 'selected' : ''; ?>>
                                        Faible
                                    </option>
                                    <option value="moyenne" <?php echo ($besoin['priorite'] === 'moyenne') ? 'selected' : ''; ?>>
                                        Moyenne
                                    </option>
                                    <option value="haute" <?php echo ($besoin['priorite'] === 'haute') ? 'selected' : ''; ?>>
                                        Haute
                                    </option>
                                    <option value="critique" <?php echo ($besoin['priorite'] === 'critique') ? 'selected' : ''; ?>>
                                        Critique
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="statut" name="statut" required>
                                    <option value="nouveau" <?php echo ($besoin['statut'] === 'nouveau') ? 'selected' : ''; ?>>
                                        Nouveau
                                    </option>
                                    <option value="en_cours" <?php echo ($besoin['statut'] === 'en_cours') ? 'selected' : ''; ?>>
                                        En cours
                                    </option>
                                    <option value="termine" <?php echo ($besoin['statut'] === 'termine') ? 'selected' : ''; ?>>
                                        Terminé
                                    </option>
                                    <option value="rejete" <?php echo ($besoin['statut'] === 'rejete') ? 'selected' : ''; ?>>
                                        Rejeté
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="categorie" 
                                       name="categorie" 
                                       value="<?php echo htmlspecialchars($besoin['categorie']); ?>"
                                       required 
                                       maxlength="100">
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="demandeur_nom" 
                                       name="demandeur_nom" 
                                       value="<?php echo htmlspecialchars($besoin['demandeur_nom']); ?>"
                                       required 
                                       maxlength="100">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       value="<?php echo htmlspecialchars($besoin['demandeur_email']); ?>"
                                       required 
                                       maxlength="150">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="cout_estime" 
                                       name="cout_estime" 
                                       value="<?php echo htmlspecialchars($besoin['cout_estime'] ?? ''); ?>"
                                       min="0" 
                                       step="0.01">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><strong>Email :</strong> 
                                    <a href="mailto:<?php echo htmlspecialchars($besoin['demandeur_email']); ?>" class="text-decoration-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <p><strong>Délai Souhaité :</strong><br>
                                    <span class="<?php echo $besoin['delai_souhaite'] && strtotime($besoin['delai_souhaite']) < time() ? 'text-danger fw-bold' : ''; ?>">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <?php if ($besoin['delai_souhaite']): ?>
                        <li class="mb-2">
                            ...
                            <span class="<?php echo strtotime($besoin['delai_souhaite']) < time() ? 'text-danger fw-bold' : ''; ?>">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <?php if (!$editMode): ?>
                        ...
                        <a href="mailto:<?php echo htmlspecialchars($besoin['demandeur_email']); ?>?subject=Concernant votre besoin: <?php echo urlencode($besoin['titre']); ?>" class="btn btn-outline-primary">
...
<style>
@media print {
    .btn, .card-header, .btn-toolbar, .border-bottom {
