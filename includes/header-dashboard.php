...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-main fixed-top">
        <div class="container-fluid">
            ...
            <!-- User dropdown -->
            <div class="dropdown">
                <a class="dropdown-toggle text-decoration-none user-dropdown text-dark" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li class="dropdown-header">
                        ...
                        <small class="text-muted"><?php echo htmlspecialchars($user['service'] . ' - ' . ucfirst($user['role'])); ?></small>
                    </li>
        ...
        <div class="container-fluid">
            ...
            ?>
                <div class="alert alert-<?php echo ($flash['type'] == 'error') ? 'danger' : $flash['type']; ?> alert-dismissible fade show" role="alert">
                    <i class="bi bi-<?php echo $flash['type'] == 'success' ? 'check-circle' : ($flash['type'] == 'error' ? 'exclamation-triangle' : 'info-circle'); ?> me-2"></i>
        ...
        .then(data => {
            ...
            if (data.success && data.notifications) {
                if (data.notifications.length === 0) {
                    container.innerHTML = '<div class="dropdown-item-text text-center text-muted py-3">Aucune notification</div>';
                } else {
