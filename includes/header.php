            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($current_page == 'liste-besoins.php') ? 'active' : ''; ?>" href="pages/liste-besoins.php">
                                <i class="bi bi-list-ul me-2"></i>
                                Liste des Besoins
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($current_page == 'ajouter-besoin.php') ? 'active' : ''; ?>" href="pages/ajouter-besoin.php">
                                <i class="bi bi-plus-circle me-2"></i>
                                Ajouter un Besoin
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($current_page == 'statistiques.php') ? 'active' : ''; ?>" href="pages/statistiques.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages/liste-besoins.php?statut=nouveau">
                                <i class="bi bi-circle-fill text-primary me-2" style="font-size: 0.5rem;"></i>
                                Nouveaux Besoins
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="pages/liste-besoins.php?priorite=critique">
                                <i class="bi bi-exclamation-triangle-fill text-danger me-2" style="font-size: 0.8rem;"></i>
                                Priorité Critique
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="pages/liste-besoins.php?statut=en_cours">
