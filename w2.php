...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                ...
                <span class="line"><span class="word"><span class="gradient-text">la gestion des besoins</span></span></span>
            </h1>
    ...
    <script>
        ...
        function drawGradient() {
            ...
            gradient.addColorStop(0, `rgba(0, ${Math.floor(100 + Math.sin(time) * 50)}, ${Math.floor(68 + Math.cos(time) * 30)}, 0.15)`);
            gradient.addColorStop(0.5, `rgba(0, ${Math.floor(100 + Math.cos(time * 0.5) * 50)}, ${Math.floor(128 + Math.sin(time * 0.5) * 50)}, 0.08)`);
            ...
            gradient2.addColorStop(0, `rgba(${Math.floor(100 + Math.sin(time * 0.5) * 50)}, 0, ${Math.floor(100 + Math.cos(time) * 50)}, 0.1)`);
